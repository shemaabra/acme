...
/**
 * Class m210716_053438_create_table_message
 */
class m210716_053438_create_table_message extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
    	...
    	$this->createIndex(
    		'idx_message_from_user_id_user',
			'message',
			'from_user_id'
		);
    	$this->addForeignKey(
    		'fk_message_from_user_id_user',
			'message',
			'from_user_id',
			'user',
			'id',
    	...
    	$this->createIndex(
    		'idx_message_to_user_id_user',
			'message',
			'to_user_id'
		);
    	$this->addForeignKey(
    		'fk_message_to_user_id_user',
			'message',
			'to_user_id',
			'user',
			'id',
    	...
    	$this->createIndex(
    		'idx_message_trip_id_trip',
			'message',
			'trip_id'
		);
    	$this->addForeignKey(
    		'fk_message_trip_id_trip',
			'message',
			'trip_id',
			'trip',
			'id',
    ...
    {
        echo "m210716_053438_create_table_message cannot be reverted.\n";
